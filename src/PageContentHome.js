...
function PageContentHome() {
    ...
    return (<section className="min-h-screen flex flex-col content-start justify-center">
        <FadeInScrollTransition timeout={100}>
            <h2 className="section-header"><span className="text-accent">#</span>~</h2>
        </FadeInScrollTransition>
        <div className="md:pl-16 section-content">
            ...
            <FadeInScrollTransition timeout={600}>
                <h2 className="text-slate-500 mb-5 text-7xl text-7xl-dynamic">this is my underwhelming homepage<span
